      ...
      child: new Column(
        children: <Widget>[
          ...
          new DropdownButton<Category>(
            items: categories.map(categoryToDropdownMenuItem)
                             .toList(),
            value: _category,
          ...
          new DropdownButton<Category>(
            items: _category.subcategories.map(categoryToDropdownMenuItem)
                                          .toList(),
            value: _subcategory,
...
class Category {
  ...
  Category.all(String category, List<String> subcategories) {
    ...
    this.subcategories.addAll(subcategories.map(
...
List<Category> categories = [
  ...
  new Category.all('Income', ['Regular Pay',
                              ...
                              'Expense',
                              'Other']),
  new Category.all('Meals', ['Groceries',
                             'Fast Food/Convenience',
                             'Restaurant',
                             'Alcohol',
                             'Subscriptions',
                             'Other']),
  new Category.all('Health/Personal Care', ['Fitness/Sports',
                                            'Insurance/Doctor/Pharmacy',
                                            'Other']),
  new Category.all('Banking/Investment', ['Fees',
                                          'Loans',
                                          'Interest',
                                          'Other']),
  new Category.all('Education', ['Tuition',
                                 'Other']),
  new Category.all('Transportation', ['Transportation Cost (Gas/Tolls)',
                                      'Parking',
                                      'Maintenance',
                                      'Other']),
  new Category.all('Pets', ['Meals',
                            'Health/Care',
                            'Other']),
  new Category.all('Shopping', ['Clothing',
                                'Electronics',
                                'Sporting Goods',
                                'Gifts',
                                'Subscriptions',
                                'Travel',
                                'Other']),
  new Category.all('Entertainment', ['Theatre/Cinema/Concert',
                                     'Physical/Digital Media',
                                     'Sports',
                                     'Subscriptions',
                                     'Other']),
  new Category.all('Other Bills', ['Phone/Internet',
                                   'Insurance',
